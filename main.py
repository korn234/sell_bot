        ...
        class ConfirmPaymentView(View):
            ...
            async def confirm_payment(self, interaction: discord.Interaction,
                ...
                try:
                    ...
                    # Daily prices
                            video_file =discord.File("video\7F0D9946-E139-4D0E-B7C8-FD67EF2825ED.mov")
                            ...
                            await interaction.user.send(file=video_file, embed=product_embed)
                            success_msg = await interaction.edit_original_response(content="✅ ส่งข้อมูลสินค้าและวิดีโอให้คุณทาง DM แล้ว!")
                        else: 
                            # Season prices
                            ...
                            video_file = discord.File(
                                "video\RPReplay_Final1740986629.mov")
                            product_embed = discord.Embed(
                                title="🎮 รายละเอียดสินค้า",
                                description=f"ขอบคุณสำหรับการสั่งซื้อ!\n\n"
                                "**DNS กันดำ ☣️**\n"
