...
async def post_messages():
    ...
    if status_channel:
        ...
        status_message = ("```ini\n"
                          ...
                          "**📱 สถานะเกม**\n"
                          "```css\n"
                          "• ROV iOS รายซีซั่น (03/05/68) แบนเวฟรอเช็ค   🟡\n"
                          "• ROV iOS รายวัน (03/05/68)    🟢\n"
                          "• ROV Android                 🟢\n"
                          "• Free Fire                   🟢\n"
                          "• 8 Ball Pool (เจล)            🟢\n"
                          "```")
    ...
    if daily_channel:
        embed1 = discord.Embed(
            title="🎮 รายวัน ROV iOS SAVAGE",
            description=(
                "# ✨ คุณสมบัติเด่น\n"  
                "> 🛡️ ระบบป้องกันรายงานย้อนลัง\n"
                "> 🔄 อัพเดทตลอด\n"
                "> 🎨 ปรับแต่งหน้าจอได้ตามใจ\n"
                "> 💫 ฟังก์ชั่นมากมาย\n"
                "> 🌐 เล่นได้ชิวๆ\n\n"
                "# 💎 แพ็คเกจรายวัน\n"
                "```ansi\n"
                ...
                "> 💬 แอดมินดูแล 24 ชั่วโมง\n"
                "> ✨ รับประกันความปลอดภัย\n"
            ),
            color=0x2b2d31
        )
        embed1.set_thumbnail(url="https://media.discordapp.net/attachments/1301468241335681024/1369168572986822787/IMG_8095.png?ex=681ae119&is=68198f99&hm=b9da02e5d92b8a54caf1c446b2102feed58ac9cccdc2dd78473b9a126edda56f&=&format=webp&quality=lossless&width=383&height=378")
        embed1.set_image(url="https://media.discordapp.net/attachments/1366123564771835994/1367160525493899345/att.-tSGKz9H0h_YYa1oXLy-3Y08qniWWH4WoIuvlicUENA.jpg")
        embed1.set_footer(text="✨ เลือกแพ็คเกจด้านล่างเพื่อสั่งซื้อ", icon_url="https://media.discordapp.net/attachments/1301468241335681024/1369168572986822787/IMG_8095.png?ex=681ae119&is=68198f99&hm=b9da02e5d92b8a54caf1c446b2102feed58ac9cccdc2dd78473b9a126edda56f&=&format=webp&quality=lossless&width=383&height=378")
        await daily_channel.send(embed=embed1, view=DailyView())

    season_channel = bot.get_channel(SEASON_CHANNEL_ID)
    if season_channel:
        embed2 = discord.Embed(
            title="🎮 รายซี ROV iOS DoDEE",
            description=(
                "# ⚔️ คุณสมบัติพิเศษ\n"
                "> 🎯 ล็อคเป้า\n"
                "> 🛡️ กันแบน\n"
                ...
                "[2;34m1 ซีซั่น[0m\n"
                "[2;33m• 150 บาท[0m\n"
                "[0;37m• ฟีเจอร์พื้นฐาน[0m\n"
                "[0;37m• ซัพพอร์ตปกติ[0m\n\n"
                "[2;35m3 ซีซั่น[0m\n"
                "[2;33m• 300 บาท[0m\n"
                "[0;37m• ฟีเจอร์ครบทุกอย่าง[0m\n"
                "[0;37m• ซัพพอร์ตพิเศษ[0m\n\n"
                "[2;31mแบบถาวร[0m\n"
                "[2;33m• 400 บาท[0m\n"
                "[0;37m• ฟีเจอร์ครบทุกอย่าง[0m\n"
                "[0;37m• ซัพพอร์ตแบบ VIP[0m\n"
                "```\n"
                "# 🎁 โบนัสพิเศษ\n"
                "> 👑 ยศพิเศษในดิสคอร์ด\n"
                "> 🔔 แจ้งเตือนอัพเดทก่อนใคร\n"
                "> 💬 ช่องแชทซัพพอร์ตพิเศษ\n"
                "> 🎯 โหลดไม่ได้ คืนเงินเต็มจำนวน\n"
                "# *กรณีที่โหลดได้แล้ว แล้วเล่นไม่ได้ ร้านขออนุญาติไม่คืนเงิน"
            ),
            color=0x2b2d31
        )
        embed2.set_thumbnail(url="https://media.discordapp.net/attachments/1301468241335681024/1368181218180333568/att.-tSGKz9H0h_YYa1oXLy-3Y08qniWWH4WoIuvlicUENA.jpg?ex=681a954d&is=681943cd&hm=6d20cf448bf40ec1c1841cd569206e03fba2c019d8feebf24f5e4f2dee7cc903&=&format=webp&width=989&height=989")
        embed2.set_image(url="https://media.discordapp.net/attachments/1302103738164449413/1366824081101553806/att.dB0srZ2U4rRKqjuiovORCx47MUCLGNJW1Bx81KiLbBU.jpg")
        embed2.set_footer(text="🏆 แพ็คเกจซีซั่น • กดปุ่มด้านล่างเพื่อสั่งซื้อ", icon_url="https://media.discordapp.net/attachments/1301468241335681024/1368181218180333568/att.-tSGKz9H0h_YYa1oXLy-3Y08qniWWH4WoIuvlicUENA.jpg?ex=681a954d&is=681943cd&hm=6d20cf448bf40ec1c1841cd569206e03fba2c019d8feebf24f5e4f2dee7cc903&=&format=webp&width=989&height=989")
